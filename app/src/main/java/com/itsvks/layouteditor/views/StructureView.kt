...
class StructureView @JvmOverloads constructor(
     ...
     */
    init {
        // 使用 MaterialColors 获取 colorPrimary，不直接引用 attr.colorPrimary
        ...
        for (text in textViewMap.keys) {
            ...
            if (view is ViewGroup && view.isNotEmpty()) {
                ...
                if (view !is CalendarView
                    ...
                    for (i in 0 until view.childCount) {
                        val current = viewTextMap[view.getChildAt(i)]
    ...
    companion object {
        ...
        init {
            ...
            imgMap[Button::class.java.simpleName] = R.mipmap.ic_palette_button
            imgMap[ImageButton::class.java.simpleName] = R.mipmap.ic_palette_image_button
            ...
            imgMap[CheckedTextView::class.java.simpleName] = R.mipmap.ic_palette_checked_text_view
            ...
            imgMap[RadioGroup::class.java.simpleName] = R.mipmap.ic_palette_radio_group
            ...
            imgMap[TextureView::class.java.simpleName] = R.mipmap.ic_palette_texture_view
            imgMap[SurfaceView::class.java.simpleName] = R.mipmap.ic_palette_surface_view
            imgMap[SearchView::class.java.simpleName] = R.mipmap.ic_palette_search_view
            ...
            imgMap[GridLayout::class.java.simpleName] = R.mipmap.ic_palette_grid_layout
            ...
            imgMap[ConstraintLayout::class.java.simpleName] = R.mipmap.ic_palette_constraint_layout
